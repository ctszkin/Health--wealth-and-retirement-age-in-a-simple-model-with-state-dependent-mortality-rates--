...
[temp critical_point_morbid_retired] = max(v_mw==repmat(v_mr,[1 4]));
  
[temp critical_point_healthy_schooling]=max(v_hs==v_hw);
[temp critical_point_healthy_retired] = max(v_hw==repmat(v_hr,[1 4]));
...
model.criticalPoint.healthy_working2retired=critical_point_healthy_retired;
model.criticalPoint.morbid_schooling2working=critical_point_morbid_schooling;
model.criticalPoint.morbid_working2retired=critical_point_morbid_retired;
